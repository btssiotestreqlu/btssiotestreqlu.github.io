...
function getCtfData(ctf) {
    const ctfData = {
        ...
        salonalternance2024: [
            { category: "Web", ctf: { name: "Challenge Web - Facile", url: "./assets/temposalon/webch1.html"}, date: "15/05/2024" },
            { category: "Reverse", ctf: { name: "Challenge Reverse [Python] - Facile", url: "./assets/temposalon/webch2.html"}, date: "15/04/2024"},
	    { category: "Steganography", ctf: { name: "Challenge Stega - Facile", url: "./assets/temposalon/webch1.html"}, date: "15/04/2024"}
        ]
    };
    return ctfData[ctf] || [];
}
